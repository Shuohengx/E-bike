...
//--------------------------------------------------------------------//Setting
    ...
    {
        dataManager.userLocation.removeAll(keepingCapacity: false) //清空用户位置信息
        ...
        StartButton.isHidden = false  //隐藏开始按钮
        mapView.isHidden = false     //不隐藏地图
        StopButton.isHidden = false     //不隐藏关闭按钮
      //  TimeIndividualRouteFixedLabel.isHidden = false          //不隐藏标签
     //   SpeedLabel.isHidden = false          //不隐藏标签
     //   DistanceIndividualRouteFixedLabel.isHidden = false          //不隐藏标签
...
//configure buttons & label
        ...
        SpeedReferenceLabel.isHidden = false
        CurrentLeftTimerTotalLabel.isHidden = true
        
        //----//
        DistanceIndividualRouteDynamicLabel.isHidden = false
        TimeIndividualRouteDynamicLabel.isHidden = false
        ExpectedLeftTimeIndividualRouteLabel.isHidden = false
        userspeedLabel.isHidden = false
    
        mapView.isHidden = false
        
        traceUserLocation(location: locationManager.location!)   //画出用户与下一个点的路线，读取接下来路程时间求出速度
        sendfunctiontimer()
    }
//---------------------------------------------------------------------------------------//
//Define function
...
//Configure Mail Composer Interface
    func configuredMailComposeViewController() -> MFMailComposeViewController {
        ...
        mailComposerVC.setToRecipients(["shuohengx@student.unimelb.edu.au"]) // password: ebikeawesome
